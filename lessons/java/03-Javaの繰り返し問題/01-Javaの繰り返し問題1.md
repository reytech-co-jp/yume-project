...
i = 10
```
こちらのコードを開発するため処理をスキップし次の繰り返し処理へ移る`continue`という文を使用しますのでこちらを分からない場合は、こちらのサイトを参考にしてください。  
`continue`文の参考リンク：[continue文の使い方](https://www.sejuku.net/blog/20200)
...
10
```
こちらのコードを開発するため算術演算子と比較演算子を使用しますので分からない場合は、こちらのサイトを参考にしてください。
