...
`Main.java`に`int`形配列`years`を宣言して配列`years`に次のようにint型の数値を代入してください。
...
```java
【years配列の年を表示する】
yearsの元の数値配列 : [2022, 2011, 2001, 1999, 1888, 2024, 2010, 1975, 2016, 2009, 2002]
```
...
yearsの並べ替えられた数値配列 : [1888, 1975, 1999, 2001, 2002, 2009, 2010, 2011, 2016, 2022, 2024]
```
...
偶数の配列: [2022, 1888, 2024, 2010, 2016, 2002]
奇数の配列: [2011, 2001, 1999, 1975, 2009]
```
...
- その上で、例外として「100」で割り切れる年はうるう年ではないです。
- 「100」で割り切れるけど、400で割り切れる年はうるう年であります。
